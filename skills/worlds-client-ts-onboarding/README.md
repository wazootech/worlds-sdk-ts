...
Follow these steps to run the onboarding skill with your AI coding assistant:
...
Open the cloned directory in your favorite AI-assisted code editor (such as
Cursor, VS Code with Copilot/Gemini, or any other agent-enabled environment).

### Run the onboarding skill

To start the onboarding process, ask your AI coding assistant to run the
onboarding skill or guide you using the instructions in the [SKILL.md](SKILL.md)
